...
// Debian10K8s1_22 is the configuration for Debian 10.X, K8s 1.22.X extending BaseK8sInstaller
type Debian10K8s1_22 struct {
	BaseK8sInstaller
}

func (u *Debian10K8s1_22) swapStep(bki *BaseK8sInstaller) Step {
	return &ShellStep{
...
func (u *Debian10K8s1_22) firewallStep(bki *BaseK8sInstaller) Step {
	return &ShellStep{
		BaseK8sInstaller: bki,
		Desc:             "FIREWALL",
		DoCmd:            "ufw disable",
...
func (u *Debian10K8s1_22) kernelModsLoadStep(bki *BaseK8sInstaller) Step {
	return &ShellStep{
		BaseK8sInstaller: bki,
		Desc:             "KERNEL MODULES",
...
func (u *Debian10K8s1_22) osWideCfgUpdateStep(bki *BaseK8sInstaller) Step {
...
func (u *Debian10K8s1_22) criToolsStep(bki *BaseK8sInstaller) Step {
	// Not available upstream
	return NewAptStepOptional(bki, "cri-tools.deb")
}

func (u *Debian10K8s1_22) criKubernetesStep(bki *BaseK8sInstaller) Step {
	// Not available upstream
	return NewAptStepOptional(bki, "kubernetes-cni.deb")
}

func (u *Debian10K8s1_22) kubectlStep(bki *BaseK8sInstaller) Step {
	return NewAptStep(bki, "kubectl.deb")
}

func (u *Debian10K8s1_22) kubeadmStep(bki *BaseK8sInstaller) Step {
	return NewAptStep(bki, "kubeadm.deb")
}

func (u *Debian10K8s1_22) kubeletStep(bki *BaseK8sInstaller) Step {
	return NewAptStep(bki, "kubelet.deb")
}

func (u *Debian10K8s1_22) containerdStep(bki *BaseK8sInstaller) Step {
...
func (u *Debian10K8s1_22) containerdDaemonStep(bki *BaseK8sInstaller) Step {
	return &ShellStep{
		BaseK8sInstaller: bki,
